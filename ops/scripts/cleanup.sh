...
WORKSPACE="${WORKSPACE:-/srv/stellcodex}"
DRIVE_ROOT="${DRIVE_ROOT:-gdrive:STELL}"
PROD_FRONTEND_ROOT="${PROD_FRONTEND_ROOT:-/srv/stellcodex/frontend}"
...
sync_dir_to_drive "${WORKSPACE}/_backups" "01_BACKUPS/server/_backups"
